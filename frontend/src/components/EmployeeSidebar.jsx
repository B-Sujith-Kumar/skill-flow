...
const EmployeeSidebar = () => {
  ...
  return (
    <aside className="flex flex-col font-rubik gap-10 px-4 py-4 fixed top-0 left-0 max-w-xs h-full pl-6 max-[1200px]:hidden">
      <div>
      ...
      <ul className="flex flex-col gap-7 mt-2 pl-8">
