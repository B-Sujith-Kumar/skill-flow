...
const JobDetails = ({ jobDetails }) => {
  return (
    <div className="mb-8">
      <div className="font-rubik bg-white px-6 py-4 rounded-3xl max-w-4xl mx-auto">
      ...
      <div className="font-rubik bg-white px-6 py-4 rounded-3xl max-w-4xl mx-auto mt-8">
